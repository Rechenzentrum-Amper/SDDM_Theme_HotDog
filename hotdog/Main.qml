...
Rectangle {
    ...
    Connections {
        ...
        onLoginFailed: {
            ...
            errorMsgText.text = "Nice, you fucked up."
        }
    }
    ...
    Rectangle {
        ...
        Image {
            id: loginBackground
            width: Math.max(mainColumn.width) + 300
            height: Math.max(mainColumn.height) + 300
            ...
            Column {
                ...
                Column {
                    ...
                    TextBox {
                        ...
                        KeyNavigation.backtab: shutdownRowButton; KeyNavigation.tab: passwordBox
                        Keys.onPressed: {
                ...
                Row {
                    ...
                    anchors.horizontalCenter: parent.horizontalCenter
                        Button {
                            id: loginRowButton
                            width: Math.max(chooserRow.width / 2 ) - 5
                            color: "#9a6d46"
                            text: "Fuck things up"
                            onClicked: sddm.login(userNameTextBox.text, passwordBox.text, sessionIndex)
                            KeyNavigation.backtab: chooserLayoutBox; KeyNavigation.tab: shutdownRowButton
                        }
                        Button {
                            id: shutdownRowButton
                            width: Math.max(chooserRow.width / 2 ) - 5
                            color: "#9a6d46"
                            text: "Fuck things up even worse"
                            onClicked: sddm.powerOff()
                            KeyNavigation.backtab: loginRowButton; KeyNavigation.tab: userNameTextBox
                        }
                }
            }
        }
